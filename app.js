  ...
  app.get('/free_agentOLs2018', function(req, res) {
    models.nfl2018freeagents.findAll({where: {position: 'OL'}, order: [['id']]}).then(function(picks){
    res.render('free_agentOLs2018', {picks: picks});
    });
  });
